...
- (void)setIsDragable:(BOOL)isDragable {
    ...
    if (_isDragable) {
        self.gesture = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(handleSwipe:)];
             ...
             usingSpringWithDamping:1
              initialSpringVelocity:0.1
                         ...
                         animations:^{
                             ...
                             fromViewController.view.frame = CGRectOffset(fromFrame, fromFrame.size.width * 0.85 * -1, 0);
             ...
             usingSpringWithDamping:1
              initialSpringVelocity:0.1
                         ...
                         animations:^{
                             ...
                             toViewController.view.frame = CGRectMake(0, 0, endRect.size.width, endRect.size.height);
...
- (void)updateInteractiveTransition:(CGFloat)percentComplete {
    ...
    CGFloat toX = 0.f;
    if (updateRect.size.width * 0.85 * -1 + CGRectGetWidth(fromViewController.view.bounds) * percentComplete >= 0) {
        toX = 0;
    } else {
         toX = (updateRect.size.width * 0.85 * -1 + CGRectGetWidth(fromViewController.view.bounds) * percentComplete) * 0.7;
    }

    toViewController.view.frame = CGRectMake(toX,
                                             0,
                                             CGRectGetWidth(fromViewController.view.frame),
                                             CGRectGetHeight(fromViewController.view.frame));;
          ...
          initialSpringVelocity:0.1
                     ...
                     animations:^{
                         ...
                         fromViewController.view.frame = CGRectMake(0,0,
                                                                    CGRectGetWidth(fromViewController.view.frame),
                                                                    CGRectGetHeight(fromViewController.view.frame));
                         toViewController.view.frame = CGRectOffset(toFrame, toFrame.size.width *0.85 * -1, 0);
                     } completion:^(BOOL finished) {
